...
Apollo has no dedicated adapter yet; wire `createGraphQLDIContext` in `requestDidStart` →
`willSendResponse` (see guide).

| Server | Example | Guide |
| ------ | ------- | ----- |
| Apollo Server 4+ | [`examples/apollo-graphql`](https://github.com/valid-lab/wyrly/tree/main/examples/apollo-graphql) | [GRAPHQL_DISPOSE](https://github.com/valid-lab/wyrly/blob/main/guides/GRAPHQL_DISPOSE.md) |
