...
Wyrly repository には実行可能な examples が含まれています。それぞれの example は、1 つの
scenario と 1 つの learning goal に絞っています。
...
## Examples を composition-root の参考にする

Examples は意図的に小さく作られています。Provider registration をどこに置くべきか、request
scopes をどう作るか、framework code から application use cases にどう処理を渡すかを確認するために使ってください。
